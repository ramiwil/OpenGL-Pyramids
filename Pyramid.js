class Pyramid {
    ...
    render() {
        ...
        // front
        drawTriangle3DUV( [0,0,0,  0.5,1,0.5,  1,0,0], [0,0, 0.5,1, 1,0] );
        ...
        //back
        drawTriangle3DUV( [0,0,1,  0.5,1,0.5,  1,0,1], [0,0, 0.5,1, 1,0] );
        ...
        drawTriangle3DUV( [0,0,0,  0.5,1,0.5,  0,0,1], [0,0, 0.5,1, 1,0] );

        //drawTriangle3DUV( [0,0,0,  0,1,1,  0,0,1], [0,0, 1,1, 1,0] );
        //drawTriangle3DUV( [0,0,0,  0,1,1,  0,1,0], [0,0, 0,1, 1,1] );

        // left side
        drawTriangle3DUV( [1,0,0,  0.5,1,0.5,  1,0,1], [0,0, 0.5,1, 1,0] );
